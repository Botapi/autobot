        ...
        foreach ($events['events'] as $event) {
            ...
            switch(strtolower($ask)) {
                ...
                case 'วันไหนคณะเปิดทำการบ้าง':
                    ...
                    break;
                case 'กำหนดการกิจกรรมของคณะเดือนพฤษจิกายนมีอะไรบ้าง':
                ...
                case 'คำถามยอดฮิต':
                    ...
                    break;
                case 'ติดต่อ':
                    $respMessage = 'เลขที่ 21 หมู่ที่ 6 ตำบลรัษฎา อำเภอเมือง จังหวัดภูเก็ต 83000
                    หมายเลขโทรศัพท์ 076-240-474 ต่อ 4000, 076-211-959 ต่อ 4000 | หมายเลขโทรศัพท์ / โทรสาร 076-218-80';
                    break;
